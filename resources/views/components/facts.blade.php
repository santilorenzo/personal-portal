<section id="facts" class="facts">
  <div class="container">
    ...
    <div class="section-title">
      <h2>Facts</h2>
      <p>Here are some numbers that describe my work in the last {{ $workingYears }} years</p>
    </div>
    ...
    <div class="row no-gutters">
      ...
      <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch" data-aos="fade-up" data-aos-delay="300">
        <div class="count-box">
          ...
          <span data-purecounter-start="0" data-purecounter-end="{{ $coffee }}" data-purecounter-duration="1" class="purecounter"></span>
          <p><strong>Coffe</strong></p>
        </div>
      </div>
